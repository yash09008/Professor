...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1914332052 5494978873').split()]
...
# File Channels
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003674096367').split()]

# Force Subscribe Settings
REQUEST_TO_JOIN_MODE = bool(environ.get('REQUEST_TO_JOIN_MODE', True))
TRY_AGAIN_BTN = bool(environ.get('TRY_AGAIN_BTN', True))
auth_channel = environ.get('AUTH_CHANNEL', '-1003663403340')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://yashwantdadke_db_user:Y6C6ut2U3Dh4Nqdv@cluster0.vingf7n.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Yash filterbotdb")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'vjcollection')
MULTIPLE_DATABASE = bool(environ.get('MULTIPLE_DATABASE', False))

# Multiple Database URIs
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+QxYSkfxITJo3NzI9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Yash_tech_pro')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscussion')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Appelez_moi_professor')
